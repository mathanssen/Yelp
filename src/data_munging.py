...
chars = ["-", " ", "Normally"]
df_businesses = df_businesses.assign(
    time_opened="", time_closed="", time_opened2="", time_closed2=""
)
df_businesses.reset_index(drop=True, inplace=True)
...
df_businesses = df_businesses.merge(
    df_quantity, left_on="region", right_on="region", how="left"
)
